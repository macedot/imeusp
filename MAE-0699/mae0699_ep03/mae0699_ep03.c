...
int main(int argc, char* argv[])
{
	...
	printf("\tPontos para estimar Theta .....: %u\n", NumPtsTheta);
	printf("\tPontos para estimar a Integral : %u\n", NumPtsInt  );
	printf("\tSimulacoes de Theta ...........: %u\n", NumSimTheta);
	printf("\tSimulacoes da Integral ........: %u\n", NumSimInt  );
	printf("\n");
	/****************************************************************/
	/****************************************************************/
