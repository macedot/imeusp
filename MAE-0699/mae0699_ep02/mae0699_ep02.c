 ...
 * Definicoes internas
 ******************************************************************************/
#define  USE_SFMT          /* Utiliza SFMT para geracao de numeros aleatorios */
#define  VERBOSE_MODE      /* Imprime resultados parciais */
...
static int checkRegion8(Vetor* pVetor)
{
  ...
  /* Passo dos valores de t; */
  step = (M_2PI / 100.0);
  /* "Sempre" sera menor que 2.0; */
  fMinMax = 2.0; 
...
int main(int argc, char* argv[])
{
  ...
  register uint32_t  j;
  register uint32_t  k;
  const double RadiusBola[] = { PARTE2_REGIAO_0, PARTE2_REGIAO_1, PARTE2_REGIAO_2, 
                                PARTE2_REGIAO_3, PARTE2_REGIAO_4 };
  unsigned char      bExit;
